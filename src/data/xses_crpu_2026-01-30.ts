...
export const REPORT_DATA: ReportData = {
  ...
  series: {
    ...
    trader_composition: {
      ...
      composition: {
        retail_pct: 0.9586966498393759,
        mixed_pct: 0.03074804956402019,
        instit_pct: 0.010555300596603947,
        retail_qty_pct: 0.22693736714734059,
        mixed_qty_pct: 0.3061337447226949,
        instit_qty_pct: 0.46692888812996447,
        retail_notional_pct: 0.22693137603208274,
        mixed_notional_pct: 0.3061024167322977,
        instit_notional_pct: 0.46696620723561955
      },
      trade_size: { avg: 2673.616681964204, median: 136.0 },
      over_time: {
        valid: true,
        periods: [
          {
            month: "2026-01",
            n_trades: 4250,
            retail_pct: 0.9585882352941176,
            mixed_pct: 0.030823529411764704,
            instit_pct: 0.010588235294117647,
            avg_trade_size: 2670.0664705882355,
            retail_qty_pct: 0.22413584577054257,
            mixed_qty_pct: 0.3052961950605936,
            instit_qty_pct: 0.47056795916886385,
            total_quantity: 16536400.0
          },
          {
            month: "2025-12",
            n_trades: 6567,
          ...
          },
          {
            month: "2025-08",
            n_trades: 3642,
            retail_pct: 0.9362987369577156,
            mixed_pct: 0.04969796814936848,
            instit_pct: 0.01400329489291598,
            avg_trade_size: 4562.688907193849,
            retail_qty_pct: 0.18901760831802447,
            mixed_qty_pct: 0.305898182514986,
            instit_qty_pct: 0.5050842091669895,
            total_quantity: 24005700.0
          }
        ]
      },
      peer_comparison: [
        {
          ...
          mixed_notional_pct: 0.3061024167322977,
          instit_notional_pct: 0.46696620723561955,
          avg_trade_size: 2673.616681964204,
          thresholds: { retail_max: 13500.0, instit_min: 67500.0 }
        },
        {
          ticker: "BMGU",
          currency: "SGD",
          is_target: false,
          retail_pct: 0.995575221238938,
          mixed_pct: 0.004424778761061947,
          instit_pct: 0.0,
          retail_qty_pct: 0.5717761557177615,
          mixed_qty_pct: 0.4282238442822384,
          instit_qty_pct: 0.0,
          retail_notional_pct: 0.5784425667960722,
          mixed_notional_pct: 0.42155743320392786,
          instit_notional_pct: 0.0,
          avg_trade_size: 190.53171091445427,
          thresholds: { retail_max: 13500.0, instit_min: 67500.0 }
        },
        {
          ticker: "41O",
          currency: "SGD",
          is_target: false,
          retail_pct: 0.9548542821383873,
          mixed_pct: 0.04228499910602539,
          instit_pct: 0.0028607187555873413,
          retail_qty_pct: 0.38739042000553425,
          mixed_qty_pct: 0.4904847622117686,
          instit_qty_pct: 0.12212481778269713,
          retail_notional_pct: 0.38600146500883536,
          mixed_notional_pct: 0.4901828694172968,
          instit_notional_pct: 0.12381566557386788,
          avg_trade_size: 2173.2300196674414,
          thresholds: { retail_max: 13500.0, instit_min: 67500.0 }
        },
        {
          ticker: "D5IU",
          currency: "SGD",
          is_target: false,
          retail_pct: 0.9477911646586346,
          mixed_pct: 0.04578313253012048,
          instit_pct: 0.00642570281124498,
          retail_qty_pct: 0.35118800343935047,
          mixed_qty_pct: 0.40118451761117857,
          instit_qty_pct: 0.24762747894947099,
          retail_notional_pct: 0.36967362180145874,
          mixed_notional_pct: 0.40280428007006563,
          instit_notional_pct: 0.22752209812847562,
          avg_trade_size: 2941.407389558233,
          thresholds: { retail_max: 13500.0, instit_min: 67500.0 }
        },
        {
          ticker: "H30",
          currency: "SGD",
          is_target: false,
          retail_pct: 0.9173789173789174,
          mixed_pct: 0.07814407814407814,
          instit_pct: 0.004477004477004477,
          retail_qty_pct: 0.3862139528485203,
          mixed_qty_pct: 0.5146166147920141,
          instit_qty_pct: 0.09916943235946554,
          retail_notional_pct: 0.38401811623146853,
          mixed_notional_pct: 0.5167175310273106,
          instit_notional_pct: 0.09926435274122095,
          avg_trade_size: 4027.446275946276,
          thresholds: { retail_max: 13500.0, instit_min: 67500.0 }
        },
        {
          ticker: "W8W",
          currency: "SGD",
          is_target: false,
          retail_pct: 0.8731182795698925,
          mixed_pct: 0.11490015360983102,
          instit_pct: 0.011981566820276499,
          retail_qty_pct: 0.3339814192302401,
          mixed_qty_pct: 0.4872558970192375,
          instit_qty_pct: 0.1787626837505224,
          retail_notional_pct: 0.3336903782406793,
          mixed_notional_pct: 0.4872260665257665,
          instit_notional_pct: 0.17908355523355418,
          avg_trade_size: 7080.651612903226,
          thresholds: { retail_max: 13500.0, instit_min: 67500.0 }
        },
        {
          ticker: "CTO",
          currency: "SGD",
          is_target: false,
          retail_pct: 0.8708693441789527,
          mixed_pct: 0.12455516014234876,
          instit_pct: 0.004575495678698526,
          retail_qty_pct: 0.4216147306329289,
          mixed_qty_pct: 0.5077947338651029,
          instit_qty_pct: 0.07059053550196816,
          retail_notional_pct: 0.4179923653380686,
          mixed_notional_pct: 0.5125440643164728,
          instit_notional_pct: 0.0694635703454586,
          avg_trade_size: 5764.454245043213,
          thresholds: { retail_max: 13500.0, instit_min: 67500.0 }
        },
        {
          ticker: "ODBU",
          currency: "USD",
          is_target: false,
          retail_pct: 0.8427299703264095,
          mixed_pct: 0.13353115727002968,
          instit_pct: 0.02373887240356083,
          retail_qty_pct: 0.18526480359585695,
          mixed_qty_pct: 0.40954172366621067,
          instit_qty_pct: 0.4051934727379324,
          retail_notional_pct: 0.18391077087820085,
          mixed_notional_pct: 0.40968714607068774,
          instit_notional_pct: 0.4064020830511114,
          avg_trade_size: 6439.994065281899,
        ...
        },
        {
          ...
          currency: "USD",
          is_target: false,
          retail_pct: 0.8404327248140635,
          mixed_pct: 0.1257606490872211,
          instit_pct: 0.03380662609871535,
          retail_qty_pct: 0.1569809266834454,
          mixed_qty_pct: 0.4124443844367138,
          instit_qty_pct: 0.43057468887984085,
          retail_notional_pct: 0.15433514739058293,
          mixed_notional_pct: 0.40934423015736254,
          instit_notional_pct: 0.43632062245205466,
          avg_trade_size: 6591.28891142664,
          thresholds: { retail_max: 10000.0, instit_min: 50000.0 }
        }
      ],
      currency_thresholds: {
